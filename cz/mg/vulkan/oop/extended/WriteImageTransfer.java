...
public class WriteImageTransfer extends ImageTransfer {
    public WriteImageTransfer(Image image, CommandPool commandPool, int aspect, int bpp) {
    ...
    public void write(Queue queue, int mipLevel, int arrayLayer){
